...
class TestTweetDfExtractor(unittest.TestCase):
    ...
    def test_find_full_text(self):
        ...
        'Euro abgefunden. Mit #inflation abgefunden. Mit höheren #Abgaben…',
        'RT @RolandTichy: Baerbock verkündet mal so nebenhin in Riga das Ende der '
        'Energieimporte aus Russland. Habeck rudert schon zurück, Scholz sc…']
    ...
    def test_find_hashtags(self):
        self.assertEqual(self.df.find_hashtags(), ['', '', '', 'Deutschen, Spritpreisen, inflation, Abgaben', ''])
